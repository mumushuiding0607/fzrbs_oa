...
import { getRole } from '../list/service';
import { TableRoleItem } from '../list/data';
...
const MyTree = React.forwardRef((props: MyTreeProps, ref) => {
  const initTreeData:TableRoleItem[] = [
    {
      title: '流程角色',
      key: '0',
      isLeaf: false
  ...
  const [treeData, setTreeData] = useState<TableRoleItem[]>(initTreeData);
