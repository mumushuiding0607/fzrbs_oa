...
return [
    ...
    [
        ...
        'extraPatterns' => [
            'POST getconfig' => 'getconfig',
            'POST getdepartments' => 'getdepartments',
            'POST gettasks' => 'gettasks',
            'POST gettaskdetail' => 'gettaskdetail',
            'POST submitscore' => 'submitscore',
            'POST deletescore' => 'deletescore',
            'POST updatescore' => 'updatescore',
            'POST generatetasks' => 'generatetasks',
            'POST autoscore' => 'autoscore',
            'POST getpenalties' => 'getpenalties',
            'POST getwarnings' => 'getwarnings',
            'POST calculatededuction' => 'calculatededuction',
            'POST generatewarnings' => 'generatewarnings',
            'POST deletetask' => 'deletetask',
            'POST savepenaltyinput' => 'savepenaltyinput',
            'POST calculatepenalty' => 'calculatepenalty',
            'GET getpenaltyresult' => 'getpenaltyresult',
            'GET exportpenalty' => 'exportpenalty',
        ],
        'pluralize' => false,
    ],
    [
