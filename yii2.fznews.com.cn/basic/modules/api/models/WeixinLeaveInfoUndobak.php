...
/**
 * This is the model class for table "weixin_leave_info_undobak".
 *
 ...
 * @property int|null $isout
 * @property string|null $destination
 * @property string|null $originalEndtime
 * @property float|null $originalTimes
 */
class WeixinLeaveInfoUndobak extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'weixin_leave_info_undobak';
    }
    ...
    {
        return [
            [['id', 'departmentid', 'approvalStep', 'status', 'issend', 'undoType', 'approvalType', 'isout'], 'integer'],
