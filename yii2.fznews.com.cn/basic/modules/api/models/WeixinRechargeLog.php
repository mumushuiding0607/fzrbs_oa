...
/**
 * This is the model class for table "weixin_rechargelog".
 *
 * @property int $id
 ...
 * @property int|null $weixinpay 微信充值
 * @property int|null $usertype 用户结算分类(同食堂用户账号表)
 */
class WeixinRechargeLog extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['uid', 'inserttime', 'rechargemoney', 'rechargeall', 'weixinpay', 'usertype'], 'integer'],
