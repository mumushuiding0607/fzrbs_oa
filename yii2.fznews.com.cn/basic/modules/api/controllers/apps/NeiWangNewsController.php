...
class NeiWangNewsController extends ApiBase
{
    ...
    public function actionIndex()
    {
        ...
        $url = Yii::$app->params['apiPrefix'] . 'weixin/nei-wang-news/list';
    ...
    public function actionView()
    {
        ...
        $url = Yii::$app->params['apiPrefix'] . 'weixin/nei-wang-news/view';
        $result = Tools::locaApi($postData, $url);
        if (!isset($result['errorMessage'])) {
    ...
    public function actionComments()
    {
        ...
        $url = Yii::$app->params['apiPrefix'] . 'weixin/nei-wang-news/comments';
        $result = Tools::locaApi($postData, $url);
        if (!isset($result['errorMessage'])) {
            $this->_result['data'] = $result;
        } else {
    ...
    public function actionUpdateComment()
    {
        ...
        $url = Yii::$app->params['apiPrefix'] . 'weixin/nei-wang-news/update-comment';
        $result = Tools::locaApi($postData, $url);
        if (!isset($result['errorMessage'])) {
            $this->_result['data'] = $result;
        } else {
