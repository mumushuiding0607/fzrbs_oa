...
{
    protected $refController = 'ManuscriptscoringController';
    ...
    public function actionListcatogory(){
      return $this->_runAction($this->refController, 'listcatogory','GET');
    }
    public function actionCommitapply(){
      return $this->_runAction($this->refController, 'commitapply','POST');
    }
    public function actionDelbycatogory(){
      return $this->_runAction($this->refController, 'delbycatogory','POST');
    }
    public function actionCommitbycatogory(){
      return $this->_runAction($this->refController, 'commitbycatogory','POST');
    }
    public function actionCommit(){
      return $this->_runAction($this->refController, 'commit','POST');
    }
    public function actionCommitscore(){
      return $this->_runAction($this->refController, 'commitscore','POST');
    }
    public function actionSave(){
      return $this->_runAction($this->refController, 'save','POST');
    }
    public function actionExport(){
      return $this->_runAction($this->refController, 'export','POST');
    }
    public function actionGetleaders(){
      return $this->_runAction($this->refController, 'getleaders','GET');
    }
    public function actionDelinfo(){
      return $this->_runAction($this->refController, 'delinfo','POST');
    }
    public function actionUploaddatas(){
      return $this->_runAction($this->refController, 'uploaddatas','POST');
    }
