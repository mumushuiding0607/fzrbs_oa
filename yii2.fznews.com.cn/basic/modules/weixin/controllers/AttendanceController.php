...
{
    protected $refController = 'AttendanceController';
    ...
    public function actionExportapply(){
      ...
      return $this->_runAction($this->refController, 'exportapply','POST');
    }
    public function actionAgreeall(){
      return $this->_runAction($this->refController, 'agreeall','POST');
    }
    public function actionException(){
      return $this->_runAction($this->refController, 'exception','POST');
    }
    public function actionIgnore() {
      return $this->_runAction($this->refController, 'ignore','POST');
    }
