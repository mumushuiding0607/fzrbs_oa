<template>
  <div style="display: flex;flex-direction: row;align-items: center;">
          ...
          <TimePicker_Dialog :show.sync="showTime"  @update:show="(val:any)=>showTime=val"  @update:label="(val:any)=>time=val"/>
</template>
<script  lang="ts">
import DatePicker_Dialog from '@/views/press/components/DatePicker_Dialog.vue';
import TimePicker_Dialog from '@/views/press/components/TimePicker_Dialog.vue';
import { ActionSheet,DatePicker,Field} from 'vant';

  export default {
    components: {
      ActionSheet,DatePicker,Field,DatePicker_Dialog,TimePicker_Dialog
    },
    props: ['value','label'],
    data () {
      return {
