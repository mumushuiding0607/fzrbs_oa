  ...
  <div class="page">
    ...
    <Tab   title="全部">
      <div class="searchBox">
        ...
        <span class="btn" @click="onSearch(3)">搜索</span>
      </div>
...
const cacheStore = useUserStore()
  export default {
    ...
    mounted() {
      ...
      var tab = cacheStore.userInfo?.financeMylistTab
    ...
    methods:{
      ...
      view(e:any){
        ...
        this.$router.push({name:'attendance_view',query:{thirdNo:e.thirdNo}})
      },
